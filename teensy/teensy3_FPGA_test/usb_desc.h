...
#define USB_RAWHID
  ...
  #define MANUFACTURER_NAME	{'T','h','r','e','e','-','D','i','m','e','n','s','i','o','n','a','l','-','T','h','i','n','k','i','n','g'}
  #define MANUFACTURER_NAME_LEN	26
  #define PRODUCT_NAME		{'3','D','-','S','c','a','n','n','e','r',' ','R','a','w','H','I','D'}
...
*/
  ...
  #define CONFIG_DESC_SIZE	(9 + 9+9+7+7) //#define CONFIG_DESC_SIZE	(9 + 9+9+7+7 + 9+9+7+7)
  ...
  #define MANUFACTURER_NAME	{'T','e','e','m','s','y','d','u','i','n','o'}
  ...
  #define MANUFACTURER_NAME	{'T','e','e','n','m','y','d','u','i','n','o'}
  #define MANUFACTURER_NAME_LEN	11
  ...
  #define MANUFACTURER_NAME	{'T','e','e','n','s','m','d','u','i','n','o'}
  #define MANUFACTURER_NAME_LEN	11
  ...
  #define MANUFACTURER_NAME	{'T','e','e','n','s','y','m','u','i','n','o'}
  #define MANUFACTURER_NAME_LEN	11
  ...
  #define RAWHID_USAGE_PAGE	0xFFAB  // recommended: 0xFF00 to 0xFFFF
  #define RAWHID_USAGE		0x0200  // recommended: 0x0100 to 0xFFFF
  #define MANUFACTURER_NAME	{'T','e','e','n','s','y','d','m','i','n','s'}
  #define MANUFACTURER_NAME_LEN	11
  ...
  #define MANUFACTURER_NAME	{'T','e','e','n','s','y','d','u','v','n','o'}
  #define MANUFACTURER_NAME_LEN	11
